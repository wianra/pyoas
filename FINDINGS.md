...
>
> Status legend: `[ ]` open · `[x]` fixed · `[-]` won't fix · `[~]` in progress
...
| Category | Total | Open | Fixed (WP-5) |
|---|---|---|---|
| Bugs | 14 | 8 | B-01, B-07, B-08, B-10, B-11, B-12 |
| Missing OAS features | 10 | 8 | F-01, F-06 |
| Architecture issues | 9 | 8 | A-04 |
| Test gaps | 13 | 11 | T-08, T-09 |
| **Total** | **46** | **35** | **11** |
...
|---|---|
| **High** | *(all resolved)* |
| **Medium** | B-03, B-06, B-11 *(fixed)*, A-01, A-02, F-02 |
| **Low** | B-02, B-04, B-05, B-09, B-13, B-14, F-03–F-05, F-07–F-10, A-03, A-05–A-09, T-01–T-07, T-10–T-13 |
